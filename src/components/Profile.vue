            ...
            <v-card flat>
              ...
              <v-container>
                ...
                <v-layout row wrap>
                  ...
                  <v-flex xs3>
                    <v-btn v-on:click="onChangePassword" :disabled="!changePasswordFormValid" small active-class
                           color="primary">
                      Browse Picture
                    </v-btn>
                    <v-btn v-on:click="onChangePassword" :disabled="!changePasswordFormValid" small active-class
                ...
                <v-form v-model="updateProfileFormValid" ref="updateProfileForm" lazy-validation>
                  ...
                  <v-btn v-on:click="onUpdateProfile" block :disabled="!updateProfileFormValid" large active-class
                         color="primary">
                    Update Profile
                  </v-btn>
                </v-form>
              ...
              <v-container>
                <v-form v-model="changePasswordFormValid" ref="changePasswordForm" lazy-validation>
                  ...
                  <v-text-field
                    ...
                    required
                  ></v-text-field>
                  <v-btn v-on:click="onChangePassword" block :disabled="!changePasswordFormValid" large active-class
                         color="primary">
                    Change Password
                  </v-btn>
                </v-form>
